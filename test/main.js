document.querySelector("#showMap").onclick = () => {
    const inp = document.querySelector("#mainInput");

    const c = new CopyCustom(inp.value);
    console.log(c.copy());
    document.querySelector("div").innerHTML = c.copy().replace("\n", "<br>");
}
